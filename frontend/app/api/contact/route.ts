    ...
    const autoReply = {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <p>
            I really appreciate you reaching out through my portfolio website!
            I've received your message and will get back to you as soon as I can.
          </p>

          <div style="background-color: #f1f3f5; padding: 15px; border-left: 4px solid #007bff; border-radius: 5px; margin: 20px 0;">
            <h4 style="color: #007bff; margin-top: 0;">Your message:</h4>
            <p style="font-style: italic; color: #555;">"${cleanedData.message}"</p>
          </div>

          <p>While you're waiting, feel free to connect with me:</p>
          <ul>
            <li>
              <a href="https://www.linkedin.com/in/gowtham-sriram-arepalli-71b79223a/" style="color: #007bff;">
                LinkedIn
              </a>
            </li>
            <li>
              <a href="https://github.com/g-1-4" style="color: #007bff;">
                GitHub
              </a>
            </li>
          </ul>
